...
class UserStore {
  ...
  @observable option: String = "ALL USERS";
  @observable showOnlyLine: boolean = false;
  @observable percentAll: String | number = 0;
  @observable percentBuyer: String | number = 0;
  @observable percentSeller: String | number = 0;
